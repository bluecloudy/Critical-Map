...
class User extends \User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'username', 'email', 'password', 'created', 'locations');
        }
    ...
    public function setUserName($name)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserName', array($name));
